...
for(pv in phenovals){
  ...
  save(station_list_sel, file = paste0("data/02_pheno_net/stations_",pv,"_class",cllps(classes),"_longseries.RData"))
  ...
  pheno_meta <- cbind(pheno_sel_long, lon, lat, E, N, alt)
  ...
  save(pheno_meta, file = paste0("data/02_pheno_net/pheno_meta_",pv,"_class",cllps(classes),"_longseries.RData"))
